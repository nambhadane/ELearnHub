...
import { getTeacherProfile, changePassword, UserProfile } from "@/services/api";
        ...
        <div className="lg:col-span-2 space-y-6">
            ...
            <CardContent className="space-y-4">
              ...
              {profile?.yearsOfExperience !== undefined && (
                <div className="space-y-2">
                  ...
                  <Input value={profile.yearsOfExperience} disabled />
                </div>
              )}
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => 
                    setSettings({...settings, submissionNotifications: checked})
                  }
                />
              </div>
              <Separator />
              ...
              <div className="flex items-center justify-between">
                ...
                <Switch 
                  ...
                  onCheckedChange={(checked) => 
                    setSettings({...settings, enrollmentNotifications: checked})
                  }
                />
              </div>
              <Separator />
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Auto-Grade Reminders</Label>
                  <p className="text-sm text-muted-foreground">
                    Remind me to grade pending submissions
                  </p>
                </div>
                <Switch 
                  checked={settings.autoGradeReminders}
                  onCheckedChange={(checked) => 
                    setSettings({...settings, autoGradeReminders: checked})
                  }
                />
              </div>
            </CardContent>
          ...
          <Card className="glass-card">
            ...
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label>Show Email to Students</Label>
                  <p className="text-sm text-muted-foreground">
